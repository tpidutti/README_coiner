...
const badges = {
  Apace: "[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)",
...
function generateMarkdown({title, description, intallation, usage, license, contribution, tests}) {
  return `
  # ${title}
